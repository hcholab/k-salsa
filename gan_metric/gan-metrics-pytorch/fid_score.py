...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default='str', type=str,
                        help='inception or lenet')
    
    parser.add_argument('--img_type', default=None, type=str,
                        help='inception or lenet')
    
    parser.add_argument('--k', default='k5', type=str,
                        help='inception or lenet')
    ...
    if args.data_name =='aptos':
        args.true = args.true + args.data_name +'_org.npy'
    elif args.data_name =='eyepacs':
        args.true = args.true + args.data_name +'_org_5000.npy'
    else:
        print('Undefined dataset!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
    
#     import pdb
#     pdb.set_trace()
    args.fake = [args.fake[0] + args.data_name +'_'+args.img_type+'_' + args.k + '.npy']
    ...
    wandb.init(project="fid_score", entity="eccv2022_")
