...
def epi():
    ...
    wandb.init(project="eyepacs_cls_binary_k-SALSA", entity="eccv2022_")
    ################################################
    ############ CHECK
    ###############################################
    ...
    ############ CHECK
    ###############################################
    images_path = args.images_path #'/home/minkyu/privacy/ECCV2022/nearest_neighbor_samesize/new_eccv_nearest_results/NEW_eccv_nearest_eyepacs_'+ args.k +'_crop4_1e2_1e-6/style_proj'

    # Make labels
    eyepacs_df = pd.read_csv(args.df) #pd.read_csv('/home/minkyu/privacy/ECCV2022/nearest_neighbor_samesize/ECCV/eyepacs/nearest_neighbor_centroid/labels/NEW_'+args.k+'_eyepacs_nearest_df.csv')
    print(f'No.of.training_samples: {len(eyepacs_df)}')
    ################################################
    ############ CHECK
    ###############################################
    eyepacs_label_csv = pd.read_csv(args.labels_train) #pd.read_csv('/hub_data/privacy/ECCV/data/EyePACs/train_val_eyepacs/labels/train_splited_eyepacs.csv')
...
#     print('group_by_centers_eyepacs:',len(group_by_centers_eyepacs))
    ...
    test_df = pd.read_csv(args.labels_test) #pd.read_csv('/hub_data/privacy/ECCV/data/splited_val/eyepacs/val1000_splited.csv')
    test_image_path = args.test_images_path #'/hub_data/privacy/ECCV/data/splited_val/eyepacs/sample1000_val'
