...
#     parser = argparse.ArgumentParser(description="args2")
    ...
    wandb.init(project="aptos_cls_v2", entity="eccv2022_")
    ################################################
    ############ CHECK
    ###############################################
    ...
    # create folder
    cfg.base.save_path = cfg.base.save_path  + '_' + img_type + '_' + str(trial) + 'tmptmpt'
    save_path = cfg.base.save_path 
    cfg.base.log_path = cfg.base.log_path  + '_' + img_type + '_' + str(trial)+ 'tmptmpt'
...
#     pdb.set_trace()
    ...
    ############ CHECK
    ###############################################
    images_path = '/home/minkyu/privacy/ECCV2022/nearest_neighbor_samesize/eccv_nearest_aptos_'+img_type+'/style_proj'
